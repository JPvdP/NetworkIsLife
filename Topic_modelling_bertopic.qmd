...
Let's create an anaconda environment for topic modelling with bertopic. Start by downloading anaconda from this website: https://www.anaconda.com/download
Once it's done downloading install and launch the program. You should be greated by a window that looks like this:
