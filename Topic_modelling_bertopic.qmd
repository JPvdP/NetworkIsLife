...
To install bertopic in our environment, we simply write *pip install bertopic*, between brackets you should see the * appear indicating that the code is running, and slowly you will see the different steps appearing underneath the code block:
